jQuery(document).ready(function($) {
  ...
  function wpse1_6817_btn() {
    ...
    $.post(ajaxurl, { action: 'wpse1_6817_btn', nonce: wps18472_installation.nonce }).done((res) => {
  ...
  function wpse1_6817_btn_install() {
    ...
    $.post(ajaxurl, { action: 'wpse1_6817_install', nonce: wps18472_installation.nonce }).done((res) => {
