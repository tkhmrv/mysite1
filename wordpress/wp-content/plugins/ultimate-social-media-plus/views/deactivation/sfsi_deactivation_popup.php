...
<div class="sfsi-plus-deactivation-popup" data-popup="plus-popup-1">
    ...
    <div class="sfsi-plus-deactivation-popup-content">
        ...
        <div class="sfsi-popup-header sfsi-top-header">
            <h2><?php _e('Oh! You don\'t like our plugin?','ultimate-social-media-plus'); ?></h2>
        ...
        <div class="sfsi-popup-content">
            <div class="sfsi-text">
                <p class="sfsi-please"><?php _e('PLEASE','ultimate-social-media-plus'); ?></p>
                <p class="sfsi-please-other-text"><?php _e('let us know in the Support Forum what was the issue, <br>so that we can fix it. We‘ll respond quickly!','ultimate-social-media-plus'); ?></p>
            </div>
            <div class="sfsi-go-to-support">
                <a target="_blank" href="<?php echo SFSI_PLUS_SUPPORT_FORM; ?>" class="go-to-support-forum"><?php _e('Go to Support Forum>','ultimate-social-media-plus'); ?></a>
            </div>
            <div class="sfsi-info-text">
                <p><?php _e('If you\'re not a Wordpress user yet, please sign up – it\'s quick! Once logged in you‘ll see a section at the bottom where you can ask your question.','ultimate-social-media-plus'); ?> </p>
            </div>
        </div>
        <div class="sfsi-popup-footer">
            <div class="sfsi-plus-deactivation-reason-link">
                <a href="javascript:void(0)"><?php _e('No, don\'t worry, there was a different reason, I want to de-activate it','ultimate-social-media-plus'); ?></a>
            </div>
        </div>
