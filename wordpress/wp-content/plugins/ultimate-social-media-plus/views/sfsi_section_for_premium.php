...
<div class="sfsiplus-footer-container">
    <div class="sfsiplus-footer-pointing-to-premium-plugin">
        <span class="sfsiplus-footer-pointing-to-premium-plugin__title">
            <?php _e( '...and much more is possible with', 'ultimate-social-media-plus' ); ?>
            <span class="sfsiplus-footer-pointing-to-premium-plugin__title-crown-text">
                <svg  class="sfsiplus-footer-pointing-to-premium-plugin__title-crown-text-icon" width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <?php _e( 'Premium', 'ultimate-social-media-plus' ); ?></span>
        </span>
        <div class="sfsiplus-footer-pointing-content clearfix">
            <div class="sfsiplus-footer-left-section">
                <div class="row sfsiplus-footer-left-section__row">
                    <div class="sfsiplus-equal-col-md-6">
                        <ul class="sfsiplus-footer-left-section__features-list">
                            <li class="sfsiplus-footer-left-section__features-list-item">
                                <span class="sfsiplus-left-image-section">
                                    <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/footer_banner/more_likes_shares.svg" alt="" />
                                </span>
                                <span class="sfsiplus-li-right-content">
                                    <?php _e( 'More Likes & Shares', 'ultimate-social-media-plus' ); ?>
                                </span>
                            </li>
                            <li class="sfsiplus-footer-left-section__features-list-item">
                                <span class="sfsiplus-left-image-section">
                                    <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/footer_banner/more_icon_designs.svg" alt="" />
                                </span>
                                <span class="sfsiplus-li-right-content">
                                    <?php _e( 'More icon designs', 'ultimate-social-media-plus' ); ?>
                                </span>
                            </li>
                            <li class="sfsiplus-footer-left-section__features-list-item">
                                <span class="sfsiplus-left-image-section">
                                    <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/footer_banner/themed_icons.svg" alt="" />
                                </span>
                                <span class="sfsiplus-li-right-content">
                            ...
                            <li class="sfsiplus-footer-left-section__features-list-item">
                                <span class="sfsiplus-left-image-section">
                                    <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/footer_banner/better_icon_placement.svg" alt="" />
                                </span>
                                <span class="sfsiplus-li-right-content">
                                    <?php _e( 'Better icon placement', 'ultimate-social-media-plus' ); ?>
                                </span>
                            </li>
                        </ul>
                    </div>
                    <div class="sfsiplus-equal-col-md-6">
                        <ul class="sfsiplus-footer-left-section__features-list">
                            <li class="sfsiplus-footer-left-section__features-list-item">
                                <span class="sfsiplus-left-image-section">
                                    <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/footer_banner/mobile_optimization.svg" alt="" />
                                </span>
                                <span class="sfsiplus-li-right-content">
                                    <?php _e( 'Mobile optimization', 'ultimate-social-media-plus' ); ?>
                                </span>
                            </li>
                            <li class="sfsiplus-footer-left-section__features-list-item">
                                <span class="sfsiplus-left-image-section">
                                    <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/footer_banner/faster_loading.svg" alt="" />
                                </span>
                                <span class="sfsiplus-li-right-content">
                                    <?php _e( 'Faster loading', 'ultimate-social-media-plus' ); ?>
                                </span>
                            </li>
                            <li class="sfsiplus-footer-left-section__features-list-item">
                                <span class="sfsiplus-left-image-section">
                                    <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/footer_banner/friendly_support.svg" alt="" />
                                </span>
                                <span class="sfsiplus-li-right-content">
                                    <?php _e( 'Friendly support', 'ultimate-social-media-plus' ); ?>
                                </span>
                            </li>
                            <li class="sfsiplus-footer-left-section__features-list-item">
                                <span class="sfsiplus-left-image-section">
                                    <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/footer_banner/more_platforms.svg" alt="" />
                                </span>
                                <span class="sfsiplus-li-right-content">
                                    <?php _e( 'More platforms', 'ultimate-social-media-plus' ); ?>
                                </span>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="sfsiplus-footer-right-section">
                <span class="sfsiplus-right-video">
                    <div style="position:relative;padding-top:56.25%;">
                        <iframe class="sfsiplus-right-video__wrap" src="https://video.inchev.com/videos/embed/c952d896-34be-45bc-8142-ba14694c1bd0" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen="" style="position:absolute;top:0;left:0;width:100%;height:100%;"></iframe>
                    </div>
                </span>
                <a target="_blank" href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmi_settings_page&utm_campaign=new_bottom_banner_to_checkout&utm_medium=banner" class="sfsiplus-checkout-premium-plugin-button"><?php _e( 'Check out the Premium Plugin ', 'ultimate-social-media-plus' ); ?></a>
            </div>
        </div>
    </div>
...
<div class="sfsiplus-footer-bottom-text">
    <p><?php _e( '..only 29.98 USD (includes support and updates for six months, and after that it will not be deactivated, so you can just keep using it!)', 'ultimate-social-media-plus' ); ?></p>
</div>
