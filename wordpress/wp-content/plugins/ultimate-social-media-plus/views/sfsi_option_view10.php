<div class="tab10">
    <p class="sfsiplus-small-title">
        <?php _e( 'Let us consult you if you placed the icons in the best possible way for most shares & traffic.', 'ultimate-social-media-plus' ); ?>
    </p>
    <h4><?php _e( 'Simply:', 'ultimate-social-media-plus' ); ?></h4>
    <ul class="sfsiplus-small-list">
        <li><?php
            printf(
                __( '1. Go to the %1$ssupport forum%2$s', 'ultimate-social-media-plus' ),
        ...
        <li><?php
            printf(
                __( '2. Add a new topic titled e.g. %1$s“Advice for Your-website-url.com”%2$s', 'ultimate-social-media-plus' ),
                '<b>',
                '</b>'
            );
        ?></li>
        <li><?php _e( '3. State where you currently placed the icons (URL), and what your goals are, e.g. more shares etc.', 'ultimate-social-media-plus' ); ?></li>
    </ul>
    <div class="question-banner">
        <div class="question-banner__wrap">
            <p class="question-banner__text blur-bg"><?php
                printf(
                    __( 'This review is %1$s100&#37; free%2$s and offered to you as courtesy of Ultimatelysocial.com', 'ultimate-social-media-plus' ),
                    '<span class="text--special text--bold">',
                    '</span>'
                );
            ?></p>
            <div class="question-banner__actions">
                <a href="https://goo.gl/MU6pTN#no-topic-0" target="_blank" class="question-banner__main-btn">
                    <span class="question-banner__main-btn-text"><?php _e( 'Go to forum', 'ultimate-social-media-plus' ); ?></span>
                ...
                <div class="question-banner__info popup-info">
                    <span class="popup-info__title"><?php _e( 'Trouble logging in there?', 'ultimate-social-media-plus' ); ?>
