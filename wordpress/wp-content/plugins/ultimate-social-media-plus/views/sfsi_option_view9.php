...
<div class="tab9">
    ...
    <p>
		<?php
			_e('In addition to the email- and follow-icon you can also show a subscription form that maximizes the chances that people subscribe to your the site.', 'ultimate-social-media-plus');
		?>
	</p>
    ...
    <div class="sfsi_plus_tab8_container">
        ...
        <div class="sfsi_plus_tab8_subcontainer sfsi_plus_seprater">
    		<h3 class="sfsi_plus_section_title">
            	<?php _e( 'Place it on your the site', 'ultimate-social-media-plus' ); ?>
            </h3>
        ...
        <div class="sfsi_plus_tab8_subcontainer sfsi_plus_seprater">
        	<h5 class="sfsi_plus_section_subtitle">
            	<?php  _e( 'Text above the entry field', 'ultimate-social-media-plus' ); ?>
            </h5>
                    ...
                    <div class="sfsi_plus_field">
                        <input type="text" class="small new-inp" name="sfsi_plus_form_heading_text"
                            value="<?php echo ($option9['sfsi_plus_form_heading_text']!='')
										? __($option9['sfsi_plus_form_heading_text'], 'ultimate-social-media-plus') : '' ;
									?>"/>
                    </div>           
                </div>
                <!--Row Section-->
                    ...
                    <div class="sfsi_plus_field">
                        <input type="text" class="small new-inp" name="sfsi_plus_form_button_text"
                            value="<?php echo ($option9['sfsi_plus_form_button_text']!='')
										? __($option9['sfsi_plus_form_button_text'],'ultimate-social-media-plus') : '' ;
									?>"/>
                    </div>           
                </div>
                <!--Row Section-->
